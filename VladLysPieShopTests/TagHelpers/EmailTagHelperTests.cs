using VladLysPieShop.TagHelpers;
...
namespace VladLysPieShopTests.TagHelpers
{
    public class EmailTagHelperTests
    {
        ...
        {
            EmailTagHelper emailTagHelper = new EmailTagHelper() { Address = "test@VladLyspieshop.com", Content = "Email" }; ;
            ...
            Assert.Equal("mailto:test@VladLyspieshop.com", tagHelperOutput.Attributes[0].Value);
        }
